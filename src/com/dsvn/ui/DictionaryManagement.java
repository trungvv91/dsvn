...
public class DictionaryManagement extends NgramsManagement {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tblDictionary);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DictionaryManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new DictionaryManagement().setVisible(true);
            }
        });
    }
